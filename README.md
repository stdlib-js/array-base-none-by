...
```javascript
import noneBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-none-by@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-none-by/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/array-base-none-by/actions/workflows/test.yml?query=branch:v0.2.1
